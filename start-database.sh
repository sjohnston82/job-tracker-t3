...
DB_CONTAINER_NAME="job-tracker-t3-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=job-tracker-t3 -d -p 5432:5432 docker.io/postgres
